...
const Contact = () => {
  return (
    <section className='max-h-screen w-full md:pt-[50px] md:px-10 flex flex-col justify-between pb-3 gap-20'>

      <div className='flex justify-between px-4 pt-12'>
        <div 
          className='text-4xl md:text-5xl flex flex-col md:flex-row  md:gap-4'>
      ...
      <div className='flex items-center'>
        ...
        <div className='w-full flex flex-col gap-3 md:pl-10'>
          <div 
      ...
      <div className='flex flex-col md:flex-row justify-between overflow-hidden border-b md:gap-10 px-4'>
        <div className=' w-full pt-4'>
          <p className={`text-5xl md:text-[120px] md:-mb-[30px] md:-mt-[30px]  ${xirod.className}`}>Contact</p>
        </div>
